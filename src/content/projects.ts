// Anything marked PLACEHOLDER was made up so you can see how the site looks when filled in.
// Replace it with what you actually did before publishing. Find them all with:
...
export const projects: Project[] = [
  {
    ...
    stack: ["C++", "Python"],
    links: { github: "https://github.com/floaterw/chess-engine" }, // PLACEHOLDER: repo doesn't exist yet
    image: "/images/projects/chess-engine.png", // PLACEHOLDER: mock screenshot
    video: "/images/projects/chess-engine-demo.webm", // PLACEHOLDER: mock demo clip
    metrics: [
      // PLACEHOLDER: all three numbers
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          // PLACEHOLDER: the story and numbers below
  ...
  },
  {
    ...
    image: "/images/projects/banking-app.png", // PLACEHOLDER: mock screenshot
    metrics: [
      // PLACEHOLDER: all three numbers
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "The fix was to lock the account row for the length of each transfer, so the second one waits for the first. After that the stress test came back clean every time, and I kept it in the test suite so it runs on every change.",
        ],
      },
      {
  ...
  },
  {
    ...
    image: "/images/projects/housing-dashboard.png", // PLACEHOLDER: mock screenshot
    metrics: [
      // PLACEHOLDER: all three numbers
  ...
  },
  {
    ...
    image: "/images/projects/video-platform.png", // PLACEHOLDER: mock screenshot
    metrics: [
      // PLACEHOLDER: all three numbers
  ...
  },
  {
    ...
    image: "/images/projects/weather-app.png", // PLACEHOLDER: mock screenshot
    metrics: [],
    featured: false,
    sections: [
      {
...
export function getSmallerProjects(): Project[] {
  return projects.filter((p) => !p.featured);
}
